...
export const SendMoney = () => {
    ...
    const name = searchParams.get("name") || ""; // Default to empty string if name is null
    ...
    const handleTransfer = async () => {
        try {
            ...
            // Validate amount and id before sending the request
            if (!id || isNaN(transferAmount) || transferAmount <= 0) {
                alert("Please provide valid ID and amount.");
                return;
            }
